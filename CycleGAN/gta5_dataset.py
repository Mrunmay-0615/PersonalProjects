...
class GTA5_loader():
    ...
    def __init__(
        ...
        self.ids = glob(os.path.join(self.label_base_path, "*.png"))
    ...
    def __getitem__(self, index):
        ...
        if self.augmentations!=None:
            img, lbl = self.augmentations(img), self.augmentations(lbl)
        # print(img.size)
...
if __name__ == "__main__":
    ...
    cfg = {
        "rootpath" : "../../GTACitySeg/Dataset3/Source_GTA5",
        "split" : "train",
        "img_rows" : 256,
        "img_cols" : 428,
        "is_transform": True,
    ...
    dst = GTA5_loader(cfg, augmentations=augmentations)
    bs = 4
